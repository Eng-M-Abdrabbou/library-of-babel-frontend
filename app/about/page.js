    ...
    return (
        <div className="container">
            <div className="card">
                ...
                <ul>
                    <li><b>How it Works:</b> A number (the "state") is repeatedly fed into the formula `newState = (a * oldState + c) % M` to produce the next state. Each state corresponds to a character.</li>
                ...
                <p>
                    ...
                    All calculations, especially for large numbers, are handled using JavaScript's `BigInt` data type, which is
